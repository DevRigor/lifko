  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto flex min-h-[calc(100vh-81px)] max-w-7xl items-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto w-full max-w-xl rounded-[2rem] border border-border/70 bg-[radial-gradient(circle_at_top_left,oklch(0.74_0.14_210/0.18),transparent_44%),linear-gradient(180deg,color-mix(in_oklab,var(--card)_92%,transparent),color-mix(in_oklab,var(--background)_88%,transparent))] p-8 shadow-sm shadow-black/5 sm:p-10">
