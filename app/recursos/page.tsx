  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,oklch(0.74_0.14_210/0.28),transparent_50%),radial-gradient(circle_at_bottom_right,oklch(0.63_0.1_145/0.20),transparent_45%)]" />
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            <div className="rounded-3xl bg-card/80 p-5 backdrop-blur shadow-[0_4px_20px_rgba(21,28,34,0.07)] hover:shadow-[0_8px_32px_rgba(21,28,34,0.10)] transition-shadow duration-300">
              <div className="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center mb-4">
                <FolderOpenDot className="h-5 w-5 text-primary" />
              </div>
              <p className="text-sm font-semibold text-foreground">Carpetas tematicas</p>
            ...
            <div className="rounded-3xl bg-card/80 p-5 backdrop-blur shadow-[0_4px_20px_rgba(21,28,34,0.07)] hover:shadow-[0_8px_32px_rgba(21,28,34,0.10)] transition-shadow duration-300">
              ...
              <p className="text-sm font-semibold text-foreground">Documentos disponibles</p>
            ...
            <div className="rounded-3xl bg-card/80 p-5 backdrop-blur shadow-[0_4px_20px_rgba(21,28,34,0.07)] hover:shadow-[0_8px_32px_rgba(21,28,34,0.10)] transition-shadow duration-300">
              ...
              <p className="text-sm font-semibold text-foreground">Acceso claro</p>
